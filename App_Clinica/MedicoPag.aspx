<%@ Page Title="Administración de Médicos" Language="C#" MasterPageFile="~/Clinica.Master" AutoEventWireup="true" CodeBehind="MedicoPag.aspx.cs" Inherits="App_Clinica.MedicoPag" %>
        ...
        <div class="col-12 col-md-11 col-lg-9">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h4 class="text-dark fw-bold m-0">
                    <i class="bi bi-heart-pulse-fill text-primary me-2"></i>Médicos Registrados
                </h4>
                <a href="MedicoForm.aspx" class="btn border-0 fw-bold px-4 py-2 shadow-sm rounded-3 btn-sm" style="background-color: #D0E4F7; color: #1C3345;">
                    <i class="bi bi-person-plus me-1"></i> Agregar Nuevo Médico
                </a>
            </div>

            <div class="card bg-white p-4 rounded-3 shadow-sm border-0 mb-4">
                <div class="table-responsive" style="max-height: 500px; overflow-y: auto;">
                    <asp:GridView ID="dgvMedico" runat="server" DataKeyNames="IdMedico" 
                        CssClass="table table-hover align-middle border-0 small" GridLines="None"
                        OnRowCommand="dgvMedico_RowCommand" AutoGenerateColumns="false" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Matrícula" DataField="Matricula" ItemStyle-CssClass="text-secondary" />
                            ...
                            <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="220px" ItemStyle-CssClass="text-end">
                                <ItemTemplate>
                                    <div class="d-inline-flex justify-content-end w-100">
                                        ...
                                        <asp:LinkButton ID="btnVerHorario" runat="server" CssClass="btn btn-sm btn-link text-info text-decoration-none fw-bold p-0 me-3"
