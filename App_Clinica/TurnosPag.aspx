...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        // Escuchador de ASP.NET AJAX PageRequestManager(corrige error de pantalla frizada)
        if (typeof Sys !== 'undefined') {
            var prm = Sys.WebForms.PageRequestManager.getInstance();
            prm.add_endRequest(function (sender, args) {
                // Cada vez que termine un PostBack de UpdatePanel, aseguramos que el body reviva
                if (!document.querySelector('.modal.show')) {
                    // Si no hay ningún modal visible en pantalla, limpiamos rastros fantasmas
